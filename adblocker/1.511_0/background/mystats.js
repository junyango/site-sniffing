var mystats = function() {
    ...
    function shouldReportFrequently() {
        // reporting-changes: reduced from 30 stats sent to 1
        return statsSent < 1 && that.installTime != null && isLastMinutes(that.installTime, 60);
    }
    ...
    function reportStats() {
        try {
            ...
            statsBufferNextReport = shouldReportFrequently() ?
                ...
                new Date(that.timeGetter().getTime() + getRandomWithinRange(180, 360) * 60 * 1000); // every 3-6 hours

...
stndz.resources = {
    ...
    blockingRules: 'http://app.standsapp.org/lists/blocking-rules/2',
    cssRules: 'http://app.standsapp.org/lists/css-rules',
    popupRules: 'http://app.standsapp.org/lists/popup-rules/2',
    jsRules: 'http://app.standsapp.org/lists/js-rules/2',
    whitelist: 'http://app.standsapp.org/lists/whitelist/4',
    ...
    detectionSites: 'http://app.standsapp.org/lists/detection-sites',
    detectionSettings: 'http://app.standsapp.org/lists/detection-settings',
